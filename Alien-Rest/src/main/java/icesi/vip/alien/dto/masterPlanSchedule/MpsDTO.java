...
public class MpsDTO {
	...
	public int getPeriodsOfSupply() {
		return periodsOfSupply;
	}
	public void setPeriodsOfSupply(int periodsOfSupply) {
		this.periodsOfSupply = periodsOfSupply;
	}
